...
{ 
    ...
    ST0 |= 0x000C;//_0008_SAU_CH3_STOP_TRG_ON | _0004_SAU_CH2_STOP_TRG_ON;    /* disable UART1 receive and transmit */ STMK1 = 1U;    /* disable INTST1 interrupt */
    ...
    SRPR11 = 1U;
    SRPR01 = 1U;
    SMR02 = 0x0022;//_0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0000_SAU_TRIGGER_SOFTWARE | //_0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END; SCR02 = 0x8097;//_8000_SAU_TRANSMISSION | _0000_SAU_INTSRE_MASK | _0000_SAU_PARITY_NONE | _0080_SAU_LSB | _0010_SAU_STOP_1 | //_0007_SAU_LENGTH_8; SDR02 = 0x8800;
    NFEN0 |= 0x04;//_04_SAU_RXD1_FILTER_ON;
    SIR03 = 0x0007;//_0004_SAU_SIRMN_FECTMN | _0002_SAU_SIRMN_PECTMN | _0001_SAU_SIRMN_OVCTMN;    /* clear error flag */ SMR03 = 0x0122;//_0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0100_SAU_TRIGGER_RXD | _0000_SAU_EDGE_FALL | // _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END; SCR03 = 0x4097;//_4000_SAU_RECEPTION | _0000_SAU_INTSRE_MASK | _0000_SAU_PARITY_NONE | _0080_SAU_LSB | _0010_SAU_STOP_1 | //_0007_SAU_LENGTH_8; SDR03 = 0x8800;;
    SO0 |= 0x0004;//_0004_SAU_CH2_DATA_OUTPUT_1;
    SOL0 |= 0x0000;//_0000_SAU_CHANNEL2_NORMAL;    /* output level normal */ SOE0 |= 0x0004;//_0004_SAU_CH2_OUTPUT_ENABLE;    /* enable UART1 output */ /* Set RxD1 pin */
    PMC0 &= 0xFDU;
    PM0 |= 0x02U;
    /* Set TxD1 pin */
    PMC0 &= 0xFEU;
    P0 |= 0x01U;
    PM0 &= 0xFEU;
    SO0 |= 0x0004;//_0004_SAU_CH2_DATA_OUTPUT_1;    /* output level normal */ SOE0 |= 0x0004;//_0004_SAU_CH2_OUTPUT_ENABLE;    /* enable UART1 output */ SS0 |= 0x000C;//_0008_SAU_CH3_START_TRG_ON | _0004_SAU_CH2_START_TRG_ON;    /* enable UART1 receive and transmit */
#endif 
}
